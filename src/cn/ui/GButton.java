...
public class GButton extends JButton {  
    ...
    public static final Color BUTTON_COLOR1 = new Color(205, 255, 205);  //背景色
    public static final Color BUTTON_COLOR2 = new Color(51, 154, 47);    //浅字体色
//    public static final Color BUTTON_COLOR1 = new Color(125, 161, 237);  //背景色
//    public static final Color BUTTON_COLOR2 = new Color(91, 118, 173);   //浅色字体
    ...
    public GButton(int style) {  
        ...
        setForeground(BUTTON_FOREGROUND_COLOR);      //预设置字体颜色  白色
        setFocusPainted(false);  
        setContentAreaFilled(false);  
        addMouseListener(new MouseAdapter() {  
            @Override  
            public void mouseEntered(MouseEvent e) {  
//                setForeground(BUTTON_FOREGROUND_COLOR);  //鼠标在按键上，改变字体颜色为白色
                hover = true;  //控制透明度tran
                repaint();  
            }  
  
            @Override  
            public void mouseExited(MouseEvent e) {  
//                setForeground(BUTTON_COLOR2);         //鼠标移开按键，字体颜色边浅字体色
                hover = false;  //控制透明度tran
                repaint();  
            }  
        });  
    }  
